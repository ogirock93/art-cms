...
$page=$_GET['page']; 
	if (!$page){
		if (file_exists('../index.php')) {
		    $pagehref= '../index.php';
		    $iframesrc='admin/load-page.php?page=index.php';
		  } else {
		      $pagehref='../index.html';
		      $iframesrc='admin/load-page.php?page=index.html';
		  }
	}else{
		$pagehref ='../'.$page;
		$iframesrc='admin/load-page.php?page='.$page;
	}
...
if (!$page){
 if (file_exists('../index.php')) {
    ...
    $iframesrc='index.php?page=index.php';
  } else {
      header('Location: index.php?page=index.html ');
      $iframesrc='index.php?page=index.html';
  }
}
session_start();
...
<?php if (!$dev){ ?>
<iframe src="<?php echo $iframesrc; ?>" id="art_site_content">
	<?php  
...
<div id="art_save_dev_content" data-art-href='<?php echo $page; ?>'><i class="fa fa-floppy-o" aria-hidden="true"></i><div class="art-save-success"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
</div>
<?php }  ?>
